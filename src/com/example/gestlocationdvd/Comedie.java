...
public class Comedie extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.comedie);
		...
		listaction.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(Comedie.this, VuDetail.class);
...
//		item.setIcon(R.drawable.abc_list_divider_mtrl_alpha);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
		case R.id.item1 : 
			Intent intent = new Intent(Comedie.this, Accueil.class);
			
			intent.putExtra("id_client", test.getInt("id_client"));
			startActivity(intent);
			break;
		case R.id.item2:
			Intent intent2 = new Intent(Comedie.this, About.class);
			Bundle test2=getIntent().getExtras();
			intent2.putExtra("id_client", test2.getInt("id_client"));
			startActivity(intent2);
			break;
		case R.id.item3:
			Intent intent3 = new Intent(Comedie.this, Connexion.class);
			startActivity(intent3);
			break;
		case R.id.item4:
			Intent intent4 = new Intent(Comedie.this, Searchable.class);
